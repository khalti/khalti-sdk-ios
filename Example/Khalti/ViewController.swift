...
class ViewController: UIViewController, KhaltiPayDelegate {
    ...
    @IBAction func payNow(_ sender: UIButton) {
        ...
        let subitServerKey = "test_public_key_535bb7993a1d40649dd27a1008adab2b"
        
        let TEST_CONFIG:Config = Config(publicKey: subitServerKey, amount: 60000, productId: "1234567890", productName: "Dragon_boss", productUrl: "http://gameofthrones.wikia.com/wiki/Dragons",additionalData: additionalData)
